# Snapshot: synergyaudio

Static-site snapshot of **https://www.synergyaudio.com**
...
```
synergyaudio.yourdomain.com {
    reverse_proxy synergyaudio:80
}
```
